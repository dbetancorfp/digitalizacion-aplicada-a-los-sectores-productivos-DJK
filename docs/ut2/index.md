...
![Desglose del término "Tecnologías Habilitadoras Digitales"](img_resumen/tecnologias_habilitadoras_etimologia.png)
...
![Icono-mapa de dispositivos domésticos y personales conectados a la nube](img_resumen/iot_dispositivos_conectados.png)
...
![Fachada acristalada del edificio The Edge en Ámsterdam](img_resumen/edificio_the_edge.png)
...
![Persona usando la cámara del móvil para ver un elemento de realidad aumentada superpuesto en un entorno real](img_resumen/ar_movil_ejemplo.png)
...
![Persona con gafas de realidad virtual observando una pantalla con un vehículo digitalizado](img_resumen/vr_gafas_diseno.png)
...
![Vaca con collar sensorizado GPS y aplicación móvil de seguimiento del ganado](img_resumen/ganado_iot_trazabilidad.png)
...
![Vista aérea de un edificio con fachada verde de paneles biológicos](img_resumen/casa_biq_algas.png)
...
![Pirámide de los tres modelos de servicio en la nube (IaaS, PaaS y SaaS) con logotipos de empresas reales](img_resumen/saas_paas_iaas_piramide.png)
...
![Infografía con las cinco "V" del Big Data: volumen, variedad, velocidad, veracidad y valor](img_resumen/big_data_5v_infografia.png)
...
![Diagrama con un avión real a la izquierda, su réplica digital a la derecha y los datos que conectan ambos en el centro](img_resumen/gemelo_digital_tres_elementos.png)
...
<details>
<summary>Ver respuestas (con la sección donde se explican)</summary>
